...
php7.0-intl php7.0-gd php7.0-curl php7.0-zip php7.0-xml php7.0-mcrypt php7.0-sqlite redis-server mysql-server beanstalkd postgresql postgresql-contrib
