...
php7.0-intl php7.0-gd php7.0-curl php7.0-zip php7.0-xml php7.0-mcrypt php7.0-sqlite php7.0-soap redis-server mysql-server beanstalkd postgresql-9.6 postgresql-contrib
